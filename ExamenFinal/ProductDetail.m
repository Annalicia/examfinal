...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.productName.text          = self.nameProduct;
    self.productPrice.text    = self.priceProduct;
...
- (IBAction)pay {
    ...
    payment.amount = [NSDecimalNumber decimalNumberWithString:_productPrice.text];
    payment.currencyCode = @"MXN";
    payment.shortDescription = self.nameProduct;
